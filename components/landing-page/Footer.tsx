...
export const Footer = () => {
  ...
  return (
    <section className="py-12 bg-gradient-to-r from-white via-white text-black mt-60">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl text-black">
        <div className="text-center xl:flex xl:items-center xl:justify-between xl:text-left text-black">
          <div className="xl:flex xl:items-center xl:justify-start">
            {/* <img className="w-auto mx-auto h-7" src="https://cdn.rareblocks.xyz/collection/celebration/images/logo-alt-2.svg" alt="" /> */}

            <p className="mt-5 text-sm  xl:ml-6 xl:mt-0">
